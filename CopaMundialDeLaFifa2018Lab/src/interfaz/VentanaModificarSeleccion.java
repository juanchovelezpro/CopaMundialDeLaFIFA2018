...
public class VentanaModificarSeleccion extends JDialog implements ActionListener {
	...
	public VentanaModificarSeleccion(PanelSelecciones sel) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (command.equals(INSERTAR)) {
			...
			Seleccion laSele = selecciones.getPrincipal().getListSel().getSelectedValue();

			JFileChooser chooser = new JFileChooser();
			chooser.showOpenDialog(null);
			chooser.isVisible();
			rutaImagen = chooser.getSelectedFile().getAbsolutePath();
			Icon imagen = new ImageIcon(laSele.getImagen());
		...
		if (command.equals(GUARDAR)) {
			...
			Seleccion sel = selecciones.getListaSeleccion().getSelectedValue();	
			labImagenSel.setIcon(new ImageIcon(sel.getImagen()));
			selecciones.getPrincipal().modificarSeleccion(sel,getTxtPais(), sel.getImagen(), getTxtPuntos());
